...
.btn-nueva { font-size: 12px; color: #4F46E5; font-weight: 600; background: none; border: none; cursor: pointer; }

.pref-desc { font-size: 12px; color: #94A3B8; margin-bottom: 12px; }
.pref-pills { display: flex; gap: 10px; }
.pref-pill { flex: 1; display: flex; flex-direction: column; align-items: center; gap: 4px; padding: 10px; border: 1.5px solid #E6E9EF; border-radius: 13px; background: #fff; cursor: pointer; font-size: 13px; font-weight: 600; color: #475569; transition: border-color 0.2s; }
.pref-pill.active { border-color: #4F46E5; color: #4F46E5; background: #EEF0FE; }
.pref-val { font-family: 'JetBrains Mono', monospace; font-size: 10.5px; color: #94A3B8; font-weight: 400; }
.pref-pill.active .pref-val { color: #4F46E5; }
.pref-ok { font-size: 12px; color: #16A34A; font-weight: 600; margin-top: 10px; }

.cat-list { background: #fff; border: 1px solid #E6E9EF; border-radius: 16px; padding: 14px 16px; }
.cat-group-title { font-size: 10.5px; font-weight: 600; color: #94A3B8; text-transform: uppercase; letter-spacing: 0.06em; margin-bottom: 8px; }
.cat-row { display: flex; align-items: center; gap: 10px; padding: 7px 0; border-bottom: 1px solid #F8F9FC; }
.cat-row:last-child { border-bottom: none; }
.cat-dot { width: 10px; height: 10px; border-radius: 50%; flex: none; }
.cat-label { flex: 1; font-size: 13px; color: #0F172A; }
.cat-badge { font-size: 10px; color: #94A3B8; background: #F1F5F9; padding: 2px 7px; border-radius: 999px; }
.btn-del { background: none; border: none; color: #CBD5E1; font-size: 14px; cursor: pointer; padding: 0 4px; }
.cats-empty { font-size: 12px; color: #94A3B8; padding: 8px 0; }
